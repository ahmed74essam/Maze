...
class AnotherWindow(QWidget):
    def __init__(self):
        ...
        layout = QVBoxLayout()
        self.resize(600,400)
        self.setStyleSheet("background-color:rgb(110,10,10)")
        self.label = QLabel()
        self.label_1 = QLabel()
        ...
        self.button.setStyleSheet("background-color:rgb(110,10,10)")
...
class Ui_OutWindow(object):
    def setupUi(self, outWindow):
        ...
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label.setText("Ahmed Essam Abdallah 192100088,Mohamed Hazem 192100040")

        self.label.setText("Please choose an algorithm:")
        #Label
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(1, 1, 200, 200))
        font = QtGui.QFont()
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color:rgb(110,10,10)")
